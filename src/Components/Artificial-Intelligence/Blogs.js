  ...
  <div className="gpt3__blog section__padding" id="blog">
    ...
    <div className="gpt3__blog-container">
      <div className="gpt3__blog-container_groupA">
        <a href="https://wearebrain.com/blog/ai-data-science/ai-trends-for-2022/" target="_blank" rel="noreferrer"><Article imgUrl={ai01} date="Dec 20, 2021" text="Artificial Intelligence (AI) continues to be a powerful change catalyst for global industries and businesses as we edge deeper into the digitally transformed society. " link="Click to Read Full Article" /></a>
      </div>
      <div className="gpt3__blog-container_groupB">
        <a href="https://blogs.nvidia.com/blog/2021/12/17/top-5-edge-ai-trends-2022/" target="_blank" rel="noreferrer"><Article imgUrl={ai02} date="Dec 17, 2021" text="Top 5 trends in Artificial Intelligence" link="Click to Read Full Article" /></a>
